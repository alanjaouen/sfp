...
## [39.0.2](https://github.com/alanjaouen/sfp/compare/v39.8.0...v39.0.2) (2026-06-08)


### Features

* **cicd:** allow sfp docker image to build on push to main ([9fe94cd](https://github.com/alanjaouen/sfp/commit/9fe94cdc297bf0c9b36bcb87fbacda917fd8b002))
* **cicd:** simplify using release-please ([6312fdf](https://github.com/alanjaouen/sfp/commit/6312fdf43948265ece64cbb02d7c82098d64ff00))
* **ci:** retrieve and use version from package.json in Docker build ([25e7bf7](https://github.com/alanjaouen/sfp/commit/25e7bf724ef4a2b9e89e6ee99fe683c29e97d046))
* **dependency:install:** add release def filter v2 ([#108](https://github.com/alanjaouen/sfp/issues/108)) ([644f700](https://github.com/alanjaouen/sfp/commit/644f700d6c2b0babe849bdb1066a8432e54c33d2))
* **deployment:** Use native SF polling instead of hard coded 30 seconds ([#176](https://github.com/alanjaouen/sfp/issues/176)) ([3b46046](https://github.com/alanjaouen/sfp/commit/3b460461892564df54df478328d57bf8b43ff10a))
* **deps:** add cross-env to package.json for cross-platform compatibility ([28ae6f3](https://github.com/alanjaouen/sfp/commit/28ae6f3b01a77028b9bb38ac373a35b99d4636be))
* **deps:** bump salesforce libs ([#157](https://github.com/alanjaouen/sfp/issues/157)) ([9ab1eca](https://github.com/alanjaouen/sfp/commit/9ab1eca9ec939af942a29d40a3c6f825528d0ddd))
* **deps:** update dependencies of docker images ([#147](https://github.com/alanjaouen/sfp/issues/147)) ([1a8b754](https://github.com/alanjaouen/sfp/commit/1a8b7548a78d1e11da742244141f35c7ed29c87b))
* **diff:** update apex link to 3.2.1 ([783b1c9](https://github.com/alanjaouen/sfp/commit/783b1c999463fd9d08b15f5c03029682f5a57b19))
* **dockerfile:** improve mechanism to build locally ([#86](https://github.com/alanjaouen/sfp/issues/86)) ([ddcc19f](https://github.com/alanjaouen/sfp/commit/ddcc19f1428b242a2fcbe67d6f4e154ba9ea55b4))
* **docker:** update docker with latest cli versions ([783787e](https://github.com/alanjaouen/sfp/commit/783787e5dc2d6dd0d0745871bee07a71d60aae90))
* **docker:** update sfp cli version ([b631f2d](https://github.com/alanjaouen/sfp/commit/b631f2de5b2733d7d58ddb0541a7238b518d6a86))
* **pool:** add password to fetched scratch org from pool ([#135](https://github.com/alanjaouen/sfp/issues/135)) ([299859b](https://github.com/alanjaouen/sfp/commit/299859b3e4f1c47c5660cf379f653f9ecec5a14b))
* **salesforce:** Upgrade core libs to v8 ([f0c5b62](https://github.com/alanjaouen/sfp/commit/f0c5b62d060c90379af841b5d1cb2ec4ed6490a6))
* **sfdxSchema:** update schema to v8 ([389b74a](https://github.com/alanjaouen/sfp/commit/389b74a7b81b76587c4dab3aec4d8fb8dc29eb89))
* **sfprofiles:** update to v5 ([f2752d0](https://github.com/alanjaouen/sfp/commit/f2752d0c99189fbb2583484696d34cb7ad141841))
* upgrade salesforce dependencies and migrate to oclif v4 ([#180](https://github.com/alanjaouen/sfp/issues/180)) ([9fa2e8e](https://github.com/alanjaouen/sfp/commit/9fa2e8e4a47207c9f23a6613eb1687583fea8d57))


### Bug Fixes

* add keywords for better discoverability via npmjs.com ([#91](https://github.com/alanjaouen/sfp/issues/91)) ([2ae2e64](https://github.com/alanjaouen/sfp/commit/2ae2e64f15531d2d7b4003424d6bdceb1b384421))
* an empty commit to trigger release please ([d8cb2a3](https://github.com/alanjaouen/sfp/commit/d8cb2a3178b4052c374090376c597dc68e684194))
* **artifact:** remove change as part of [#128](https://github.com/alanjaouen/sfp/issues/128) ([4a32970](https://github.com/alanjaouen/sfp/commit/4a32970208a052df338b729d396e51f01141ff26))
* **artifact:** undo earlier fix from [#128](https://github.com/alanjaouen/sfp/issues/128) ([2e138b0](https://github.com/alanjaouen/sfp/commit/2e138b0cc0f6da6dadb7c686f12c3b1e4ba98031))
* **chore:** fix PR template documentation link ([#59](https://github.com/alanjaouen/sfp/issues/59)) ([89f1bd3](https://github.com/alanjaouen/sfp/commit/89f1bd38c72716d0cd67d9d79a8cf3a53f8457a7))
* **cicd:** add a release-as next for the release configuration ([1dfc27c](https://github.com/alanjaouen/sfp/commit/1dfc27c2bc39820737150cedf0d3802c71c1efd9))
* **cicd:** add bootstrap sha to root ([3fb6b01](https://github.com/alanjaouen/sfp/commit/3fb6b0108578a03db987531045fc128bc9cc5957))
* **cicd:** add prerelease option to release-please config ([7ca1b25](https://github.com/alanjaouen/sfp/commit/7ca1b252fc0cba0d0b8d9dc6ced97fda342ac272))
* **cicd:** create as draft ([5315eea](https://github.com/alanjaouen/sfp/commit/5315eeac423ac02bfa690fcc10288d6ea01616a3))
* **cicd:** fix create as pre-release ([265b20c](https://github.com/alanjaouen/sfp/commit/265b20c78ff182cc93ce85af8b9114cad0673530))
* **cicd:** fix incorrect build process ([2b184ac](https://github.com/alanjaouen/sfp/commit/2b184acde6a0d7773599486dd6c436e89ff851ee))
* **cicd:** fix move to prerelease in root ([c886ea1](https://github.com/alanjaouen/sfp/commit/c886ea17de57c301e1b145557dc7b78a21ecad02))
* **cicd:** remove alpha stage from release pipeline ([14955a6](https://github.com/alanjaouen/sfp/commit/14955a604a5e314d59613e305acc5e66307417a1))
* **cicd:** switch to GITHUB_TOKEN ([841fd4a](https://github.com/alanjaouen/sfp/commit/841fd4a555fac811c785592538d35693663be745))
* **cicd:** update release please configs to draft ([b7a9a8c](https://github.com/alanjaouen/sfp/commit/b7a9a8ce59115da8d1f8a3071720245e6e16c86d))
* **cicd:** update to use version from package.json ([37aae9d](https://github.com/alanjaouen/sfp/commit/37aae9d82882de5129aeaef57c537ca73fca9ada))
* **dependency:resolver:** missing dependencies due to package directory order ([#107](https://github.com/alanjaouen/sfp/issues/107)) ([eb2fa37](https://github.com/alanjaouen/sfp/commit/eb2fa3787dd427f1eff963c123ede64478bd2a13))
* **dependency:** fix incorrect dependency resolution by favouring latest ([#143](https://github.com/alanjaouen/sfp/issues/143)) ([5e0dd5b](https://github.com/alanjaouen/sfp/commit/5e0dd5bdf1481780f0067859b30eb8180fc5a078))
* **dependency:** fixes incorrect transitive dependency resolution ([5e0dd5b](https://github.com/alanjaouen/sfp/commit/5e0dd5bdf1481780f0067859b30eb8180fc5a078))
* **deploy:** 54-Skip deployment when deployment ([111c4e9](https://github.com/alanjaouen/sfp/commit/111c4e9c679bc8c73a2d26fcd8c2afc25fb51f1b))
* **deps:** fix deps to mitigate issuses casued by sfplogger update ([#132](https://github.com/alanjaouen/sfp/issues/132)) ([75da44f](https://github.com/alanjaouen/sfp/commit/75da44f17a644dc9cc54ea355ae7f4c13e40a575))
* **deps:** update apexlink to 3.1.2 ([#93](https://github.com/alanjaouen/sfp/issues/93)) ([f7d0460](https://github.com/alanjaouen/sfp/commit/f7d046069c8b28718a6637a1e702b9eb386472d2))
* **docker:** fix image tagging ([8003a4f](https://github.com/alanjaouen/sfp/commit/8003a4f88ade9557ba8bac8a2c920cb89bad093f))
* **docker:** fix incorrect version being passed in during docker build ([68b6447](https://github.com/alanjaouen/sfp/commit/68b64478f7e888fdf6e5abe7e7901b6d3c6d283b))
* **docker:** push to rebuild docker ([d168ed7](https://github.com/alanjaouen/sfp/commit/d168ed779fd8c1660ba06a3cf995d203fecbbdd9))
* **docs:** update license info ([f555bf4](https://github.com/alanjaouen/sfp/commit/f555bf482f931c0056e0799ee5e2d99f45cff0fd))
* **engine:** handle fields getting undefined for picklist ([6c8c712](https://github.com/alanjaouen/sfp/commit/6c8c7127891136f4bc5773f21e7c394d0f0af5a9))
* **engine:** implement retry logic for fetching org details ([#204](https://github.com/alanjaouen/sfp/issues/204)) ([517689b](https://github.com/alanjaouen/sfp/commit/517689bea6ec9a24b513c5b67ff7d2866ec03b83))
* error in windows "Error: EPERM: operation not permitted, unlink" ([#134](https://github.com/alanjaouen/sfp/issues/134)) ([357b118](https://github.com/alanjaouen/sfp/commit/357b11885872dfd59ef608a5c025147ccfac1ea1))
* **fht:** fht/ft not being applied for post deployment ([#101](https://github.com/alanjaouen/sfp/issues/101)) ([93a01cf](https://github.com/alanjaouen/sfp/commit/93a01cf0dddded24a94c6a349c9950276f53b66f))
* **git:** add /tests/ to .gitignore ([741ade8](https://github.com/alanjaouen/sfp/commit/741ade881b927d8c65af8aa89e7149d98fc5d9ae))
* **git:** respect .gitignore when copying source directory ([#158](https://github.com/alanjaouen/sfp/issues/158)) ([3592c50](https://github.com/alanjaouen/sfp/commit/3592c502efeac3b7fc13f02a7ddaa2a4627f3164))
* package.json & package-lock.json to reduce vulnerabilities ([8431a04](https://github.com/alanjaouen/sfp/commit/8431a044abcd609273e5abc0aeaa7f21228b9642))
* **package:** change package name to @alanjaouen/sfp and update publishConfig ([fb4a2be](https://github.com/alanjaouen/sfp/commit/fb4a2be7b2b082a2625b1b66c3a976f4fc541bea))
* **pool:** make pools using snapshot pools respect max allocation ([#104](https://github.com/alanjaouen/sfp/issues/104)) ([a39b7d5](https://github.com/alanjaouen/sfp/commit/a39b7d5e46af02d0abae71789b011a22a965570d))
* **profiles:** update sfp profiles to 5.2.1 ([14af1f0](https://github.com/alanjaouen/sfp/commit/14af1f096566ad0cef3749abee631d68ce2abd48))
* **release:** correct typo in log message for package promotion ([#203](https://github.com/alanjaouen/sfp/issues/203)) ([01af673](https://github.com/alanjaouen/sfp/commit/01af6737cd90e97f8f4f35d2b0475ba3fc68e1d1))
* **release:** update release title to August 24 ([a060838](https://github.com/alanjaouen/sfp/commit/a060838542a0b56cd686577e221fdab1f758b195))
* **schema:** fix missing enableFT to schema ([#106](https://github.com/alanjaouen/sfp/issues/106)) ([6138447](https://github.com/alanjaouen/sfp/commit/61384476edb31466524f8e83a0de6199802b6cf3))
* **schema:** update typos in sfdx-project.schema.json ([cc39d24](https://github.com/alanjaouen/sfp/commit/cc39d24703c871bcae8a4e2bcb5be5286df960e5))
* **SFDMURunImpl:** remove log level parameter from generated command ([21ea1c4](https://github.com/alanjaouen/sfp/commit/21ea1c4bc14a714b090968ead27f9f44bb2964fc))
* **SFDMURunImpl:** remove log level parameter from generated command ([7e2ad40](https://github.com/alanjaouen/sfp/commit/7e2ad40b02fa693c63f61161be362ef23290b327))
* **sfdxFlags:** fix broken compatibility due to v6 to v8 upgrade ([8a57ef3](https://github.com/alanjaouen/sfp/commit/8a57ef35495d42af5940e0b835ab0eb87d3431de))
* **sfp:** add community edition notice ([317eff9](https://github.com/alanjaouen/sfp/commit/317eff93d6625249f736564068804d755e0dedf6))
* **sfppackage:** fix handling of URL-encoded spaces in repository URLs ([#138](https://github.com/alanjaouen/sfp/issues/138)) ([c50cd25](https://github.com/alanjaouen/sfp/commit/c50cd254a3faa675a9f717e1b2c758b575ce64c5))
* **sfpPackage:** fix issue with test class not detected ([ef40c71](https://github.com/alanjaouen/sfp/commit/ef40c71e1feb1822d421318c43f36bea2f9837c5))
* streamline child component processing in FHTEnabler and FTEnabler ([#167](https://github.com/alanjaouen/sfp/issues/167)) ([0ee696c](https://github.com/alanjaouen/sfp/commit/0ee696cd9c90ede80e2e3f8450c28d171d4e8506))
* **tests:** add space in log messages for better readability ([#168](https://github.com/alanjaouen/sfp/issues/168)) ([891e2a1](https://github.com/alanjaouen/sfp/commit/891e2a1580805936ff94388cc63aecce8efd016d))
* **tracking:** ensure local tracking after resetting remote tracking ([#152](https://github.com/alanjaouen/sfp/issues/152)) ([3e312e9](https://github.com/alanjaouen/sfp/commit/3e312e9e700e7d93143e016ae78f1d54deaecf43))
* **typo:** fix typo with unlocked package collection log ([443bbae](https://github.com/alanjaouen/sfp/commit/443bbae04c56b520551d90a2c40d63637a7cc436))
* **typo:** Typos on user outputs and docs ([#58](https://github.com/alanjaouen/sfp/issues/58)) ([6279245](https://github.com/alanjaouen/sfp/commit/6279245148ffaf7ac78dd2bca6e6cef980bd1974))
* update type definitions and clean up unused imports ([096c42e](https://github.com/alanjaouen/sfp/commit/096c42ebdf91fad98f4fe084db7cbee63da3754d))
* **utils:** fix incorrect commenting of  CRUDHelper ([aa4f73a](https://github.com/alanjaouen/sfp/commit/aa4f73aa845c70af358db107ee5a7b4e894e77ea))
* **wf:** update to pre release ([d8391c8](https://github.com/alanjaouen/sfp/commit/d8391c8d92e7cfa6286df92a32089b3f32ab88c1))
* **workflows:** update npm token to GitHub token and upgrade Node.js version ([fb4a2be](https://github.com/alanjaouen/sfp/commit/fb4a2be7b2b082a2625b1b66c3a976f4fc541bea))


### Miscellaneous Chores

* **main:** release 39.0.1 ([155d05e](https://github.com/alanjaouen/sfp/commit/155d05e5500e8f652036fb3398506ebc2d68fc2f))
* **main:** release 39.0.2 ([99e2581](https://github.com/alanjaouen/sfp/commit/99e258193cb39f3b13a8a6f230bbe2004317e37f))
* release 39.0.1 ([ae8ad28](https://github.com/alanjaouen/sfp/commit/ae8ad28a434e4a969f7c648cacf2c7c3936c70e2))
